package dev.lounres.thetruehat.client.common.ui.nrfa
...
import dev.lounres.thetruehat.client.common.uiTemplates.TheTrueHatPageTemplateUI


@Composable
public fun NewsRulesFaqAboutSectionHeadUI(
    text: String,
    enabled: Boolean,
    onClick: () -> Unit,
) {
...
@Composable
public fun NewsRulesFaqAboutPageUI(component: NewsRulesFaqAboutPageComponent) {
