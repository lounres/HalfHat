...
public class FakeRoundBreakPageComponent(
    ...
    unitsUntilEnd: RoomDescription.UnitsUntilEnd = RoomDescription.UnitsUntilEnd.Words(100),
    ...
    override val unitsUntilEnd: Value<RoomDescription.UnitsUntilEnd> = MutableValue(unitsUntilEnd)
