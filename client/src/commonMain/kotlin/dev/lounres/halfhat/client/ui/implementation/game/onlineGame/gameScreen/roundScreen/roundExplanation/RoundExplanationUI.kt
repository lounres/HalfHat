...
fun RoundExplanationGameCardUI(
    ...
    Column(
        ...
        when (gameState.role.roundRole) {
            is ServerApi.OnlineGame.Role.Round.Explanation.RoundRole.Speaker ->
                Column(
            ...
            ServerApi.OnlineGame.Role.Round.Explanation.RoundRole.Listener ->
                Column(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalAlignment = Alignment.CenterHorizontally,
                ) {
            ...
            ServerApi.OnlineGame.Role.Round.Explanation.RoundRole.Player ->
                Row(
