...
import dev.lounres.halfhat.client.ui.implementation.game.onlineGame.gameScreen.gameInitialisation.GameInitialisationUI
...
import dev.lounres.halfhat.client.ui.implementation.game.onlineGame.gameScreen.roomGathering.RoomGatheringUI
...
public fun GameScreenUI(
    ...
    when (child) {
        ...
        is GameScreenComponent.Child.RoomGathering -> RoomGatheringUI(child.component, windowSizeClass)
        is GameScreenComponent.Child.GameInitialisation -> GameInitialisationUI(child.component, windowSizeClass)
