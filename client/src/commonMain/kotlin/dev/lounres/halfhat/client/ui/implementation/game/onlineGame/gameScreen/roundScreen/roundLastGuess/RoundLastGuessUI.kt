        ...
        when (val globalRole = gameState.selfRole.globalRole) {
            is ServerApi.OnlineGame.SelfRole.Round.LastGuess.GlobalRole.Player ->
                when (globalRole.roundRole) {
                    is ServerApi.OnlineGame.SelfRole.Round.LastGuess.GlobalRole.Player.RoundRole.Speaker ->
                        Column(
                    ...
                    ServerApi.OnlineGame.SelfRole.Round.LastGuess.GlobalRole.Player.RoundRole.Listener ->
                        Column(
                            modifier = Modifier.fillMaxWidth(),
                            horizontalAlignment = Alignment.CenterHorizontally,
                        ) {
            ...
            is ServerApi.OnlineGame.SelfRole.Round.LastGuess.GlobalRole.Spectator ->
                Row(
                    modifier = Modifier.fillMaxWidth().height(80.dp),
                ) {
                    Card(
