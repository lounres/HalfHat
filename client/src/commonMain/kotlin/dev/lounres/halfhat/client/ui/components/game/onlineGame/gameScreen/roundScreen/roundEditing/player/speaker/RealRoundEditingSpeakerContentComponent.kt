...
class RealRoundEditingSpeakerContentComponent(
    override val roundRole: StateFlow<ServerApi.OnlineGame.SelfRole.Round.Editing.GlobalRole.Player.RoundRole.Speaker>,
    ...
    override val onGuessed: (UInt) -> Unit = { wordIndex ->
        onUpdateExplanationResults(
            roundRole.value.wordsToEdit.toKoneMutableList().apply {
