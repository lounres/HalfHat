...
import dev.lounres.halfhat.client.ui.components.MainWindowDebugComponent
import dev.lounres.halfhat.client.ui.components.RealMainWindowDebugComponent
...
val dpSizes = KoneList.of<DpSize>(
    DpSize(360.dp, WindowSizeClass.HEIGHT_DP_EXPANDED_LOWER_BOUND.dp + 30.dp),
    DpSize(WindowSizeClass.WIDTH_DP_MEDIUM_LOWER_BOUND.dp + 30.dp, WindowSizeClass.HEIGHT_DP_EXPANDED_LOWER_BOUND.dp + 30.dp),
    DpSize(WindowSizeClass.WIDTH_DP_EXPANDED_LOWER_BOUND.dp + 30.dp, WindowSizeClass.HEIGHT_DP_EXPANDED_LOWER_BOUND.dp + 30.dp),
    DpSize(WindowSizeClass.WIDTH_DP_LARGE_LOWER_BOUND.dp + 30.dp, WindowSizeClass.HEIGHT_DP_EXPANDED_LOWER_BOUND.dp + 30.dp),
    DpSize(WindowSizeClass.WIDTH_DP_EXTRA_LARGE_LOWER_BOUND.dp + 30.dp, WindowSizeClass.HEIGHT_DP_EXPANDED_LOWER_BOUND.dp + 30.dp),

//    DpSize(360.dp, 640.dp), // Mi Note 3
//    DpSize(540.dp, 1200.dp), // POCO X5 Pro 5G
)
...
fun main() {
    application(
        ...
        var component by remember { mutableStateOf<MainWindowDebugComponent?>(null) }
        
        HalfhatTheme(
            darkTheme = darkTheme,
        ) {
            component?.mainComponents?.forEach { key(it) { MainWindowUI(it) } } ?: key(null) { MainWindowUI(null) }
        }
        ...
        LaunchedEffect(Unit) {
            ...
            component = RealMainWindowDebugComponent(
                initialSettings = initialSettings,
                windowStates = dpSizes.map {
                    WindowState(
