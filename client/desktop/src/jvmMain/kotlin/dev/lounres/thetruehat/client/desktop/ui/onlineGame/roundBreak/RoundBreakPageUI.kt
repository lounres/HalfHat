package dev.lounres.thetruehat.client.desktop.ui.onlineGame.roundBreak
...
import dev.lounres.thetruehat.client.common.components.onlineGame.roundBreak.FakeRoundBreakPageComponent
            ...
            when(val userRole = component.userRole.subscribeAsState().value) {
                ...
                RoundBreakPageComponent.UserRole.ListenerReady ->
                    Button(
                        ...
                        shape = CircleShape,
                        onClick = component.onReadyButtonClick,
                    ) {
                        Text(
                            when (userRole) {
